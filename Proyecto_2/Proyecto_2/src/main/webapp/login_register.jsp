		...
		<div class="login">
			...
			<div class="login-form log">
				...
				<form action="#">
					...
					<div class="pass animation" style="--i: 5; --j: 26">
						<a href="interfaz.jsp" class="pass-link"> He olbidado mi contraseña</a>
					</div>
					<div class="crea-cuenta animation" style="--i: 6; --j: 27">
						<p>
							¿Primera vez en SeguryMail? <a href="interfaz.jsp" class="register-link">Crea
								una cuenta</a>
						</p>
					</div>
				</form>
			...
			<div class="info-text login">
				<h2 class="animation" style="--i: 0; --j: 20">¡Bienvenido de
					Nuevo!</h2>
				<p class="animation" style="--i: 1; --j: 21">¡Hola! Gracias por elegir SeguryMail. 
				¡Esperamos que disfrutes tu experiencia!</p>
			</div>
			...
			<div class="info-text regis">
				...
				<p class="animation" style="--i: 20; --j: 1">Estamos muy
					contentos de que estes aqui! Cree su cuenta de correo electronico
